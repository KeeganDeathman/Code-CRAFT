package com.keegan.lyoko.container;
...
public class ContainerCentrifuge extends Container
{
	...
	public ContainerCentrifuge(InventoryPlayer invPlayer, TileEntityCentrifuge te)
	{
		...
		this.addSlotToContainer(new SlotCentrifuge(this, tileEntity, 0, 121, 108));
		this.addSlotToContainer(new SlotCentrifuge(this, tileEntity, 1, 121, 231));
	}
